...
<form action="SecurityDetails.php"  method="post">
...
$errors = array();
if(empty($firstname) OR empty($middlename) OR empty($lastname) OR empty($gender) OR empty($datebirth)OR empty($address)OR empty($phone)OR empty($deployaddress) OR empty($role)){
array_push($errors,"All fields are required");
}
$sql = "SELECT * FROM security WHERE firstname = '$firstname' AND lastname = '$lastname'";
...
$sql = "INSERT INTO security (firstname, middlename, lastname, gender, datebirth, address, phone, deployaddress, role) VALUES (?,?,?,?,?,?,?,?,?)";
$stmt = mysqli_stmt_init($conn);
$prepareStmt = mysqli_stmt_prepare($stmt,$sql);

if($prepareStmt){
mysqli_stmt_bind_param($stmt,"sssssssss", $firstname, $middlename, $lastname, $gender, $datebirth, $address, $phone, $deployaddress,$role);
...
<input type="date" name="datebirth" require>
</td> <br> <br>
<td>
...
<input type="text" name="deployaddress" required>
</td> <br> <br>
<td>
</td> <br> <br>
<td>
...
<option value="Branch Security">Branch Security</option>  
</select>
</td> <br> <br>
</div>
...
<td><?php echo $datebirth = $row['datebirth']?></td>
<td><?php echo $address =   $row['address']?></td>
<td><?php echo $phone  = $row['phone']?></td>
<td><?php echo $role =  $row['role']?></td>
<td><?php echo $deployAddress =  $row['deployaddress']?></td>


<td>
<button class="Update"><a href="Update.php?id=<?php echo $row['id'] ?>">Update</a></button>
